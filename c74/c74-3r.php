...
<html>
 ...
 <h4> <p style="display:inline;color:blue" title="Self-dependence and other defects"> आत्माश्रयादिदोषः </p> </h4>
 <h5> श्लो.  १.१.१ - १.१.२ : </h5>

<?php
// Change character set to utf8
mysqli_set_charset($db,"utf8");
$query = "select * from mmrsv where ChapterS='अनुमानाक्षेपः' and SectionS='आत्माश्रयादिदोषः'";
