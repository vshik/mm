...
<html>
 ...
 <h4> <p style="display:inline;color:blue" title="Knowledge (ज्ञानं) is subtler than Action (कर्म)"> ज्ञानं सूक्ष्मं कर्म </p> </h4>
 <h5> श्लो.  १.१.१ - १.१.२ : </h5>

<?php
// Change character set to utf8
mysqli_set_charset($db,"utf8");
$query = "select * from mmrsv where ChapterS='कर्मज्ञानतत्त्वम्' and SectionS='ज्ञानं सूक्ष्मं कर्म'";
