...
<html>
 ...
 <h4> <p style="display:inline;color:blue" title="Unanimity of all systems of philosophy w.r.t mutual relationship between different limbs"> अङ्गाङ्गिभावानुगुण्यम्  </p> </h4>
 <h5> श्लो.  १.१.१ - १.१.२ : </h5>

<?php
// Change character set to utf8
mysqli_set_charset($db,"utf8");
$query = "select * from mmrsv where ChapterS='कर्मज्ञानतत्त्वम्' and SectionS='अङ्गाङ्गिभावानुगुण्यम्'";
